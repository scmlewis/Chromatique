      ...
      <div className="relative z-60 w-full max-w-3xl glass rounded-2xl shadow-2xl text-slate-100 border border-white/10 overflow-hidden">
        <div className="p-6 border-b border-white/10 bg-gradient-to-r from-purple-500/10 to-blue-500/10">
          <div className="flex items-start justify-between gap-4">
            <h2 className="text-3xl font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Help & Guide</h2>
            <div className="flex items-center gap-3">
              <label className="text-sm text-slate-300 flex items-center gap-2 cursor-pointer hover:text-slate-100 transition-colors">
                <input 
                  ...
                  className="w-4 h-4 rounded border-slate-600 text-purple-500 focus:ring-2 focus:ring-purple-500 cursor-pointer"
                />
                Don't show on startup
              </label>
              <button className="btn btn-ghost cursor-pointer" onClick={onClose}>Close</button>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 max-h-[70vh] overflow-y-auto space-y-6 text-sm text-slate-200">
          <section className="bg-white/5 rounded-lg p-4 border border-white/10">
            <h3 className="font-semibold text-lg text-purple-400 mb-2">Overview</h3>
          ...
          <section className="bg-white/5 rounded-lg p-4 border border-white/10">
            <h3 className="font-semibold text-lg text-purple-400 mb-2">HSL & Generation</h3>
          ...
          <section className="bg-white/5 rounded-lg p-4 border border-white/10">
            <h3 className="font-semibold text-lg text-purple-400 mb-2">Palette / Swatches</h3>
          ...
          <section className="bg-white/5 rounded-lg p-4 border border-white/10">
            <h3 className="font-semibold text-lg text-purple-400 mb-2">Favorites & Exports</h3>
          ...
          <section className="bg-white/5 rounded-lg p-4 border border-white/10">
            <h3 className="font-semibold text-lg text-purple-400 mb-2">Image Extraction</h3>
          ...
          <section className="bg-white/5 rounded-lg p-4 border border-white/10">
            <h3 className="font-semibold text-lg text-purple-400 mb-2">Accessibility & WCAG</h3>
          ...
          <section className="bg-white/5 rounded-lg p-4 border border-white/10">
            <h3 className="font-semibold text-lg text-purple-400 mb-2">Tips & Shortcuts</h3>
          ...
          <section className="bg-white/5 rounded-lg p-4 border border-white/10">
            <h3 className="font-semibold text-lg text-purple-400 mb-2">Troubleshooting</h3>
