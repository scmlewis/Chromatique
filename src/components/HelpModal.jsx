    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-60 w-full max-w-3xl glass rounded-2xl shadow-2xl text-amber-100 border border-white/10 overflow-hidden">
        ...
        <div className="p-6 max-h-[70vh] overflow-y-auto space-y-6 text-sm text-amber-200">
          ...
          <section className="bg-white/5 rounded-lg p-4 border border-white/10">
            <h3 className="font-semibold text-lg text-amber-300 mb-2">HSL & Generation</h3>
          ...
          <section className="bg-white/5 rounded-lg p-4 border border-white/10">
            <h3 className="font-semibold text-lg text-amber-300 mb-2">Palette / Swatches</h3>
          ...
          <section className="bg-white/5 rounded-lg p-4 border border-white/10">
            <h3 className="font-semibold text-lg text-amber-300 mb-2">Favorites & Exports</h3>
          ...
          <section className="bg-white/5 rounded-lg p-4 border border-white/10">
            <h3 className="font-semibold text-lg text-amber-300 mb-2">Image Extraction</h3>
          ...
          <section className="bg-white/5 rounded-lg p-4 border border-white/10">
            <h3 className="font-semibold text-lg text-amber-300 mb-2">Accessibility & WCAG</h3>
          ...
          <section className="bg-white/5 rounded-lg p-4 border border-white/10">
            <h3 className="font-semibold text-lg text-amber-300 mb-2">Tips & Shortcuts</h3>
          ...
          <section className="bg-white/5 rounded-lg p-4 border border-white/10">
            <h3 className="font-semibold text-lg text-amber-300 mb-2">Troubleshooting</h3>
