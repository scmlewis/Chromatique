 ...
 * Returns an object with { name, hex, distance }
 */
export function getClosestColorName(hexColor) {
  ...
  return {
    name: closestName,
    hex: closestHex.toUpperCase(),
    distance: Math.round(minDistance),
    isExactMatch: minDistance === 0
  }
}

/**
 * Get a human-readable description of color similarity
 */
